...
class ApiContractEvolutionEnv(
    ...
    def _parse_result(self, payload: Dict[str, Any]) -> StepResult[ApiContractObservation]:
        ...
        observation = ApiContractObservation(
            ...
            previous_phase_score=obs_data.get("previous_phase_score", 0.001),
            cumulative_score=obs_data.get("cumulative_score", 0.001),
    ...
    def _parse_state(self, payload: Dict[str, Any]) -> ApiContractState:
        ...
        return ApiContractState(
            ...
            total_score=payload.get("total_score", 0.001),
