...
|----------|-----------|-------|
| 1 — Add Optional Field | Easy | 0.38 |
| 2 — Error Code Change | Medium | 0.38 |
| 3 — Fix That Breaks | Hard | 0.38 |
| 4 — Auth Token Format | Medium | 0.38 |
| 5 — Rate Limit Semantic | Hard | 0.38 |
| 6 — GraphQL Nullability | Medium | 0.38 |

*(Actual live baseline scores generated via `inference.py` using Llama-3.1-8B with fallback actions due to API limits)*
